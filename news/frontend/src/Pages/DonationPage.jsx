...
const DonationPage = () => {
  return (
    <div>As a non-profit news site dedicated to providing accurate and up-to-date information about blockchain technology, we rely on the generosity of our readers to keep us running.
         ...
         community. Thank you for considering a donation to our news site, and for helping us promote transparency, innovation, and progress in the world of blockchain.</div>
  )
}
